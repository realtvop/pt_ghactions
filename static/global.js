import multiplayerframe from './components/multiplayer/multiplayer.js?ver=1.2.1h3';
import ChartSelectPageComponent from './components/chartselect/chartselect.js?ver=1.2.1h3';
import StartPageComponent from './components/startpage/startpage.js?ver=1.2.1h3';
import ChartDetailsPageComponent from './components/chartdetails/chartdetails.js?ver=1.2.1h3';
import PlayingPageComponent from './components/playing/playing.js?ver=1.2.1h3';
import LoginPageComponent from './components/login/login.js?ver=1.2.1h3';
import CalibratePageComponent from './components/calibrate/calibrate.js?ver=1.2.1h3';
import CacheManagePageComponent from './components/cachemanage/cachemanage.js?ver=1.2.1h3';
import AboutPageComponent from './components/aboutpage/aboutpage.js?ver=1.2.1h3';
import UserChartUploadComponent from './components/userChartUpload/userChartUpload.js?ver=1.2.1h3';
import UserChartEditComponent from './components/userChartEdit/userChartEdit.js?ver=1.2.1h3';
import PlayerB20Component from './components/playerB20/playerB20.js?ver=1.2.1h3';
import PZRankSingleComponent from './components/pzRankSingle/pzRankSingle.js?ver=1.2.1h3';

import { uploader } from './utils/js/reader.js?ver=1.2.1h3';
import shared from './utils/js/shared.js?ver=1.2.1h3';
import phizoneApi from './utils/js/phizoneApi.js?ver=1.2.1h3';
import { full } from './utils/js/common.js?ver=1.2.1h3';
import { tipsHandler } from './components/tips/tips.js?ver=1.2.1h3';
