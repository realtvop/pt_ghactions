...
self.addEventListener('install', (e) => {
    if (location.href.includes("1443/")) return;
    e.waitUntil(
...
self.addEventListener('fetch', async function (e) {
    ...
    if (urlOri.startsWith('http')) {
        if (urlParsed.host === 'res.phi.zone' || urlParsed.host === 'pzres.uotan.cn' || (urlParsed.path.startsWith('/PTVirtual/'))) {
            ...
            if (location.href.includes("1443/")) {
