import { csv2array } from "./common.js?ver=1.2.1h3";
import Pec from "./pec2json.js?ver=1.2.1h3";
...
export class ZipReader extends EventTarget {
  ...
  read(result) {
    if (!this.worker) {
      ...
      const worker = new Worker("/static/utils/js/zip.js?ver=1.2.1h3"); //以后考虑indexedDB存储url
